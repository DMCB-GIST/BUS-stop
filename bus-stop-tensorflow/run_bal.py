...
dump_path = data_path+'/logs/main_k'+str(k_shot)
if not os.path.isdir(dump_path):
    os.makedirs(dump_path)

mylog = fs.my_logging(dump_path+'/main_k'+str(k_shot)+'_log_at_seed'+si_str+'.log')
...
for si in range(start,end):
    ...
    fs.dump_all(np.array(pre_dev_confs_over_seeds),dump_path+'/main_pre_dev_confs'+si_str+'.bin')
    fs.dump_all(np.array(pre_ulb_probs_over_seeds),dump_path+'/main_pre_ulb_probs'+si_str+'.bin')
    fs.dump_all(np.array(pre_dev_probs_over_seeds),dump_path+'/main_pre_dev_probs'+si_str+'.bin')
    fs.dump_all(np.array(pre_dev_perfs_over_seeds),dump_path+'/main_pre_dev_perfs'+si_str+'.bin')
    fs.dump_all(np.array(pre_pe_epochs_over_seeds),dump_path+'/main_pre_pe_epochs'+si_str+'.bin')
    ...
    fs.dump_all(np.array(all_records_over_seeds),dump_path+'/main_all_records'+si_str+'.bin')
    fs.dump_all(np.array(all_u_probs_over_seeds),dump_path+'/main_ulb_records'+si_str+'.bin')
